...
class GoogleAuthenticatorTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->authenticator = new GoogleAuthenticator($this->totpFactory, $this->eventDispatcher, 123);
    }
    ...
    public function checkCode_validCode_dispatchCheckAndValidEvent(): void
    {
        ...
        $this->expectDispatchConsecutiveEvents([
            [$event, GoogleAuthenticatorCodeEvents::CHECK],
            [$event, GoogleAuthenticatorCodeEvents::VALID],
        ]);
    ...
    public function checkCode_invalidCode_dispatchCheckAndInvalidEvent(): void
    {
        ...
        $this->expectDispatchConsecutiveEvents([
            [$event, GoogleAuthenticatorCodeEvents::CHECK],
            [$event, GoogleAuthenticatorCodeEvents::INVALID],
        ]);
